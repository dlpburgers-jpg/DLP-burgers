...
const CACHE = 'dlp-v5-c2a27c1538f1';
const FILES = ["./index.html","./manifest.webmanifest","./favicon.svg","./icon-192.png","./icon-512.png","./dlp-circular.svg","./dlp-circular-48.png","./apple-touch-icon-circular.png","./dlp-circular-192.png","./dlp-circular-512.png","./dlp-circular-maskable-512.png","./assets/dlp-admin-logo-CKBb41bS.jpeg","./assets/dlp-burgers-banner-D8DG3Hn2.png","./assets/dlp-campaign-S8xeskhn.jpeg","./assets/index-7tnFH13a.js","./assets/index-CwPJy0jp.css","./assets/preview-disabled-CwRR3fzr.js","./assets/web-B9m6OhHy.js","./assets/web-D71rEnDk.js"];
