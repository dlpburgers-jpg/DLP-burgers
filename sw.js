/* global __ASSETS__ */
const CACHE = 'dlp-v5-a33b8d625b2d';
const FILES = ["./index.html","./manifest.webmanifest","./favicon.svg","./icon-192.png","./icon-512.png","./assets/dlp-admin-logo-CKBb41bS.jpeg","./assets/dlp-burgers-banner-D8DG3Hn2.png","./assets/dlp-campaign-S8xeskhn.jpeg","./assets/index-CetjnBOn.css","./assets/index-CrpCSgOl.js","./assets/preview-disabled-CwRR3fzr.js"];
